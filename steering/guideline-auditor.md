...
description: Audits the coverage, consistency, and freshness of AI Dev OS L3 guidelines. Use when discussing guideline maintenance, introducing a new framework, or reviewing guideline quality.
---
...
4. **Traceability**: Is each rule linked to an L2 principle?
5. **Effectiveness**: Are rules expressed in concrete, verifiable terms?
